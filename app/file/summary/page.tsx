...
export default function FilingSummaryPage() {
  ...
  if (loading) {
    return (
      <AppShell title="Filing Summary" subtitle="Loading your filing details...">
        <SectionStack>
          <WorkspaceSectionCard title="Please wait">
  ...
  if (!summary) {
    return (
      <AppShell title="No Filing Found" subtitle="We couldn't find any filing summary.">
        <SectionStack>
          <WorkspaceSectionCard title="No Data">

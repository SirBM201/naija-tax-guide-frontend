...
type WorkspaceApiInit = Omit<RequestInit, "body"> & { body?: unknown };

async function apiRequest<T>(path: string, init?: WorkspaceApiInit): Promise<T> {
  ...
  return apiJson<T>(normalizedPath, {
    ...(init || {}),
    timeoutMs: 20000,
  });
}
